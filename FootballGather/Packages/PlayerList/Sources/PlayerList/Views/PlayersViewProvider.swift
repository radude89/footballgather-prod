...
public struct PlayersViewProvider<AddView: View, DetailsView: View, ConfirmView: View> {
    ...
    public let confirmPlayersView: (_ players: [Player], _ gatherEnded: Binding<Bool>) -> ConfirmView
    ...
    public init(
        ...
        confirmPlayersView: @escaping (_ players: [Player], _ gatherEnded: Binding<Bool>) -> ConfirmView
    ) {
